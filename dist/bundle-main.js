  ...
  var e = {
      ...
      448: (e, n, t) => {
        ...
        function Wa(e, n, t, r) {
          ...
          "object" == typeof a && null !== a
            ? (l.context = Ca(a))
            : ((a = Ml(n) ? Ll : Nl.current), (l.context = Tl(e, a))),
        ...
        function Nu(e, n, t, r, l) {
          ...
          if ((Ea(n, l), null === n.stateNode))
            Bu(e, n), Ha(n, t, r), Wa(n, t, r, l), (r = !0);
          else if (null === e) {
            var o = n.stateNode,
              u = n.memoizedProps;
            o.props = u;
    ...
    (() => {
      ...
      function u() {
        ...
        function d(e, n, t, r) {
          var a = n && n.prototype instanceof b ? n : b,
            ...
            u = new M(r || []);
          return l(o, "_invoke", { value: N(e, t, u) }), o;
        }
        function p(e, n, t) {
          try {
        ...
        function z(n, t) {
          ...
          if ("throw" === a.type)
            return (
              (t.method = "throw"), (t.arg = a.arg), (t.delegate = null), y
            );
          var o = a.arg;
          return o
            ? o.done
          ...
          if (n || "" === n) {
            ...
            if (!isNaN(n.length)) {
              var l = -1,
                a = function t() {
                  for (; ++l < n.length; )
                    if (r.call(n, l)) return (t.value = n[l]), (t.done = !1), t;
        ...
        return (
          (w.prototype = k),
          l(C, "constructor", { value: k, configurable: !0 }),
          l(k, "constructor", { value: w, configurable: !0 }),
          ...
          (M.prototype = {
            ...
            delegateYield: function (n, t, r) {
              return (
                (this.delegate = { iterator: O(n), resultName: t, nextLoc: r }),
      ...
      const s = function () {
        ...
        return (
          ...
          n.createElement("div", null, n.createElement(l, null))
        );
      };
      var c = t(379),
        f = t.n(c),
      ...
      (x.styleTagTransform = k()),
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          e.addEventListener("click", function () {
            n.innerHTML
              ? (n.innerHTML = "")
              : (n.innerHTML = "You clicked the button!");
          });
        }),
        console.log("vardan  as");
      console.log(15, "hellow");
      console.log(50),
        (0, e.s)(document.getElementById("app")).render(
